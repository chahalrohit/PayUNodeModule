...
@property (nonatomic, copy) NSArray<NSDictionary<NSString *, NSString *> *> * _Nullable cartDetails SWIFT_DEPRECATED_MSG("This feature is no longer supported by the SDK");
